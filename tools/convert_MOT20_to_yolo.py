...
def generate_imgs_and_labels(opts):
    ...
    if opts.split == "test":
        ...
        if opts.split.lower() == "val":
            ...
            seq_list = ["MOT20-02"]  # 只取一个MOT20-02即可
        elif opts.split.lower() == "train":
            seq_list = ["MOT20-03", "MOT20-05"]  # 只取'MOT20-03', 'MOT20-05'
        elif opts.split.lower() == "train_overlap":
            seq_list = ["MOT20-01", "MOT20-03", "MOT20-05"]
        ...
        with open(to_file, "a") as f:
            for idx, img in enumerate(imgs):
                ...
                if split == "test" or exist_gts[idx]:
                    f.write("MOT20/" + "images/" + split + "/" + seq + "/" + img + "\n")
