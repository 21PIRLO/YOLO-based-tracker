...
try:  # for yolo v8
    # you should run `pip3 install ultralytics` first
    from ultralytics import YOLO
    from evaluate import evaluate
    print('Note: running yolo v8 detector')
    ...
    for seq in seqs:
        ...
        for i, (img, img0) in enumerate(data_loader):
            ...
            if not i % opts.detect_per_frame:  # if it's time to detect
                ...
                # NOTE: yolo v8 input type: (str | int | PIL | np.ndarray)
